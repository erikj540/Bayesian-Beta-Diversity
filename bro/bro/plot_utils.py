...
def plot_error_bars(ax, x, y, lower, upper, label=None, zorder=None, color=None):
    ax.errorbar(x, y, yerr=(y-lower, upper-y), fmt='o', label=label, zorder=zorder, color=color) # error is (lower, upper) = (mean-lower, upper-mean)
    return ax

def plot_centered_error_bars(ax, x, y, true_y, lower, upper, label=None, color=None):
    ax.errorbar(x, y-true_y, yerr=(y-lower, upper-y), fmt='o', label=label, color=color) # error is (lower, upper) = (mean-lower, upper-mean)
    return ax
